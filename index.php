...
<html>
  ...
  <body bgcolor="<?= $pbp->get_bgcolor($page, $acbf) ?>">
    <div id="container">
      <nav>
	<a href="<?= $pbp->get_prev($comic, $page, $acbf) ?>" class="navbtn" id="prevbtn"></a>
	<a href="#" class="navbtn" id="menubtn"></a>
	<a href="<?= $pbp->get_next($comic, $page, $acbf) ?>" class="navbtn" id="nextbtn"></a>
	<div id="menu">
	  <div id="menu-left">
    ...
    <div id="pagecontainer">
      <img src="<?= $pbp->get_image($comic, $page, $acbf) ?>"
	   id="page"
